...
INSERT INTO `messages` VALUES (1,'hello','2025-03-31 00:18:34',1,'12'),(2,'hi how are you!','2025-03-31 03:09:16',1,'12'),(3,'hey!','2025-03-31 03:14:11',2,'12'),(4,'Cool!','2025-03-31 03:43:01',1,'12');
...
INSERT INTO `rooms` VALUES ('12','Cool!',NULL,'1,2',1,0,1);
...
INSERT INTO `user_friends` VALUES (1,2),(2,1),(4,2);
...
INSERT INTO `user_login` VALUES (1,'native','$argon2i$v=19$m=4096,t=3,p=1$l7DGAuf7dxneiw167CdTfg$f8lZde3WSiQzlrJv3pbyQdA0a/PXWkbL1a/HpXcDdsk',1),(2,'native','$argon2i$v=19$m=4096,t=3,p=1$QjtOIYH3196fxETUfRCHjw$6zLFhWd24NyqSfRTtVIXvGC9YNAFJZTmZ+lKM3Awe5o',2),(3,'native','$argon2i$v=19$m=4096,t=3,p=1$ujGmZx9eSwFugCnNpaW+NQ$e++G88Po2dyU3T1b/9owulQqwX7zz+aJd0TCiiNI74M',3),(4,'native','$argon2i$v=19$m=4096,t=3,p=1$Y++9WVsQHxrV0rrtF7VTWg$Jkm2qYBetTGDYlUJNZPDOJiK8roxH51TRxYH8kJz54c',4);
...
INSERT INTO `users` VALUES (1,'Kelly Guo','chichigou@gmail.com','https://s3.ap-southeast-1.amazonaws.com/test.chichi-lab.com/1.png','2025-03-31','Georgia',2000,'tpe','Severe','Myself','I can\'t find proper doctor','2025-03-30 23:30:13',NULL),(2,'Bob','1@gmail.com','https://s3.ap-southeast-1.amazonaws.com/test.chichi-lab.com/4.png','2025-03-31','宜蘭縣',1999,NULL,'Moderate','Family','Just want to make friends','2025-03-31 00:10:14',NULL),(3,'John','a@gmail.com','https://s3.ap-southeast-1.amazonaws.com/test.chichi-lab.com/3.png','2025-03-31','基隆市',1922,NULL,'重度','看護','sharing my moods','2025-03-31 00:40:12',NULL),(4,'Ellen','ellen@gmail.com','https://s3.ap-southeast-1.amazonaws.com/test.chichi-lab.com/2.png','2025-03-31','Connecticut',2018,NULL,'Moderate','Family','Looking for helper ','2025-03-31 03:38:57',NULL);
...
INSERT INTO `users_rooms` VALUES (1,'12',1),(2,'12',2);
...
INSERT INTO `users_tags` VALUES (3,2),(3,5),(2,1),(2,2),(2,5),(2,6),(4,1),(4,2),(4,3),(4,4),(4,5),(4,6),(1,1),(1,2),(1,3),(1,4),(1,5),(1,6);
...
-- Dump completed on 2025-03-31 11:46:28
