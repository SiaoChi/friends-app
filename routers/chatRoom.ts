...
router.route("/api/v1/chatroom/:room").get([authenticate,chatRoomFunctions.fetchMessages]);  // 要加一個middleware，防止其他人進入
router.route("/api/v1/chatlist/:id").get([authenticate,chatRoomFunctions.fetchChatList]);  // 要加一個middleware，防止其他人進入
